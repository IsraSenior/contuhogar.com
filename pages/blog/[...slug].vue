            ...
            <!-- <div class="mt-10 max-w-2xl">
                ...
                <ul role="list" class="mt-8 max-w-xl space-y-8 text-gray-600">
                    <li class="flex gap-x-3">
                        <svg class="mt-1 size-5 flex-none text-secondary" viewBox="0 0 20 20" fill="currentColor"
                            aria-hidden="true" data-slot="icon">
                            <path fill-rule="evenodd"
                                d="M10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16Zm3.857-9.809a.75.75 0 0 0-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 1 0-1.06 1.061l2.5 2.5a.75.75 0 0 0 1.137-.089l4-5.5Z"
                                clip-rule="evenodd" />
                        </svg>
                        <span><strong class="font-semibold text-primary">Data types.</strong> Lorem ipsum, dolor sit
                    ...
                    <li class="flex gap-x-3">
                        ...
                        <span><strong class="font-semibold text-primary">Loops.</strong> Anim aute id magna aliqua ad
                    ...
                    <li class="flex gap-x-3">
                        ...
                        <span><strong class="font-semibold text-primary">Events.</strong> Ac tincidunt sapien vehicula
                ...
                <figure class="mt-10 border-l border-secondary pl-9">
                    <blockquote class="font-semibold text-primary">
                    ...
                    <figcaption class="mt-6 flex gap-x-4">
                        <img class="size-6 flex-none rounded-full bg-gray-50"
                            ...
                            alt="">
                        <div class="text-sm/6"><strong class="font-semibold text-primary">Maria Hill</strong> –
