<template>
  ...
  >
    <div
      v-if="message"
      class="mt-3 p-3 rounded-lg flex items-start gap-2 text-sm animate-fade-in"
      :class="{
    ...
    >
      ...
      <!-- Mensaje -->
      <div class="flex-1">
        <p v-if="typeof message === 'string'" class="font-medium">
          {{ message }}
        </p>
        <ul v-else class="space-y-1">
          <li v-for="(msg, index) in message" :key="index" class="font-medium">
            {{ msg }}
          </li>
        </ul>
      </div>
