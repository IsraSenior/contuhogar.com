...
const content = ref([
    ...
    `<ol class="list-decimal list-inside">
        ...
        <li>Colombianos residentes en el exterior interesados en mejorar las condiciones actuales de tu préstamo de vivienda o del inmueble mediante adecuaciones.</li>
    ...
    `<ol class="list-decimal list-inside">
        ...
        <li>Usted puede obtener uno o más créditos en Colombia, dependiendo de tu capacidad de pago.</li>
        <li>En cuanto a tu historial crediticio usted toma el crédito en Colombia y no afecta tu capacidad de pago en el país actual de residencia.</li>
    ...
    `<ol class="list-decimal list-inside">
        ...
        <li>No tener reportes negativos en las Centrales de Riesgo en Colombia; asimismo, se revisará tu endeudamiento actual y tu comportamiento en el exterior.</li>
        <li>Si desea aumentar tu capacidad de pago podrá aplicar con un familiar en Colombia o en el exterior.</li>
    ...
    `<ul class="list-disc list-inside">
        ...
        <li>Extractos bancarios de los últimos tres (3) meses de la cuenta donde le consignan tu salario.</li>
    ...
    <p class="mt-6">Una vez aprobado tu crédito, ContuHogar le brindará un acompañamiento integral en todo el proceso de legalización, incluyendo elaboración y envío del poder especial, hasta el desembolso del dinero por parte de la entidad financiera. También contará con servicio de posventa./p>
    `,

    `<p>Si desea aplicar a este crédito, descargue nuestros formularios, diligenciarlos y enviarlos a <a href="mailto:gerencia@contuhogar.net" class="text-primary hover:text-secondary">gerencia@contuhogar.net</a> o al correo <a href="mailto:gerenciacomercial@contuhogar.net" class="text-primary hover:text-secondary">gerenciacomercial@contuhogar.net</a> o al ejecutivo de crédito que esté llevando tu proceso:</p>
                ...
                <div class="lg:col-span-3">
                    <div>
                        ...
                        <div class="mt-6 text-base/7 text-gris-aluminio font-normal space-y-6">
                            ...
                            <p>
                                Una vez aprobado tu crédito, ContuHogar le brindará un acompañamiento integral en
                                todo
                                el
                    ...
                    <div class="mt-6" :delay="900">
                        <div
                            ...
                            <h2 class="text-2xl font-semibold tracking-tight text-balance text-primary sm:text-3xl">
                                Aumenta tu productividad hoy mismo</h2>
